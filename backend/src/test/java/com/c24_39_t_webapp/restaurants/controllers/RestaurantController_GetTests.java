...
import com.c24_39_t_webapp.restaurants.controllers.RestaurantController;
...
public class RestaurantController_GetTests {
    /**
     ...
     */
    @Test
    @DisplayName("GET /api/restaurant/{id} Retorna 200 OK con lista de todos los restaurantes")
     ...
     */
    @Test
    @DisplayName("GET /api/restaurant/{id} Retorna 200 OK con lista VACÍA si no hay restaurantes")
